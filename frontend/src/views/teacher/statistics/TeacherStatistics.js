...
import { API_URL, headers } from '../../../api/search/base'; // [REFACTOR] Use shared API_URL instead of hardcoded

// [REFACTOR] Removed hardcoded: const API_URL = 'http://100.67.61.71:8000/api/v1/teacher/statistics';
