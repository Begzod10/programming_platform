...
LESSONS = [
    # ------------------------------------------------------------------ 0
    {
        ...
        "text_content": (
            ...
            "<p><code>o'ng strelka tugmasi bosilganda</code> bloki — bu tugma "
            "bosilishi bilan ishga tushadi. Uning ostiga harakat blokini "
            "qo'yamiz:</p>"
            "<pre><code>o'ng strelka tugmasi bosilganda\n"
            "x ni 10 ga o'zgartir</code></pre>"
            "<p><code>x ni 10 ga o'zgartir</code> — personajni o'ngga 10 piksel "
        ...
        "text_content_ru": (
            ...
            "<p>Блок <code>o'ng strelka tugmasi bosilganda</code> запускается при "
            "нажатии этой клавиши. Под ним ставим блок движения:</p>"
            "<pre><code>o'ng strelka tugmasi bosilganda\n"
            "x ni 10 ga o'zgartir</code></pre>"
            "<p><code>x ni 10 ga o'zgartir</code> — сдвигает персонажа вправо на "
    ...
    # ------------------------------------------------------------------ 1
    {
        ...
        "text_content": (
            ...
            "Scratch'da <b>O'zgaruvchilar</b> (to'q sariq) bo'limidan "
            "\"O'zgaruvchi yasash\" ni bosib, unga <code>ball</code> deb nom "
            "beramiz.</p>"
            "<h2>Ballni oshirish</h2>"
            "<pre><code>bo'sh joy tugmasi bosilganda\n"
            "ball ni 1 ga oshir</code></pre>"
            "<p><code>ball ni 1 ga oshir</code> — har safar ball 1 taga ko'payadi. "
            "O'yin boshida ballni nolga qaytaramiz:</p>"
            "<pre><code>yashil bayroq bosilganda\n"
            "ball ni 0 ga o'rnat</code></pre>"
        ),
        "text_content_ru": (
            ...
            "Scratch в разделе <b>Переменные</b> (оранжевые) нажимаем «Создать "
            "переменную» и называем её <code>ball</code>.</p>"
            "<h2>Увеличиваем очки</h2>"
            "<pre><code>bo'sh joy tugmasi bosilganda\n"
            "ball ni 1 ga oshir</code></pre>"
            "<p><code>ball ni 1 ga oshir</code> — каждый раз очки растут на 1. В "
    ...
    # ------------------------------------------------------------------ 2
    {
        ...
        "text_content": (
            ...
            "<b>Sezish</b> (och ko'k) bo'limidagi <code>... ga tegayapti?</code> "
            "blokidan foydalanamiz.</p>"
            "<h2>Agar ... bo'lsa</h2>"
            "<p>Tekshirishni <code>agar &lt;...&gt; bo'lsa</code> bloki bilan "
            "qilamiz:</p>"
            "<pre><code>agar &lt;Olma ga tegayapti?&gt; bo'lsa\n"
            "  ball ni 1 ga oshir\n"
            "  Ushladim! deb ayt</code></pre>"
        ...
        "text_content_ru": (
            ...
            "<code>... ga tegayapti?</code> из раздела <b>Сенсоры</b> "
            "(голубые).</p>"
            "<h2>Если ...</h2>"
            "<p>Проверку делаем блоком <code>agar &lt;...&gt; bo'lsa</code>:</p>"
            "<pre><code>agar &lt;Olma ga tegayapti?&gt; bo'lsa\n"
            "  ball ni 1 ga oshir\n"
            "  Ushladim! deb ayt</code></pre>"
    ...
    # ------------------------------------------------------------------ 3
    {
        ...
        "text_content": (
            ...
            "<code>1 dan 10 gacha tasodifiy son</code> blokidan foydalanamiz — u "
            "har safar tasodifiy son beradi.</p>"
            "<h2>Tasodifiy joyga o'tish</h2>"
            "<pre><code>x: (-200 dan 200 gacha tasodifiy son) y: 150 ga o't</code></pre>"
            "<p>Bu blok personajni yuqorida, chapdan o'ngga tasodifiy joyga "
            "qo'yadi. Shunday qilib olma har safar boshqa ustundan tushadi.</p>"
        ),
        "text_content_ru": (
            "<h2>Каждый раз в новом месте</h2>"
            "<p>В интересной игре яблоко должно появляться <b>каждый раз в "
            "новом месте</b>. Для этого используем блок <code>1 dan 10 gacha "
            "tasodifiy son</code> из раздела <b>Операторы</b> (зелёные) — он "
            "каждый раз даёт случайное число.</p>"
            "<h2>Прыжок в случайное место</h2>"
            "<pre><code>x: (-200 dan 200 gacha tasodifiy son) y: 150 ga o't</code></pre>"
            "<p>Этот блок ставит персонажа вверху в случайное место слева "
            "направо. Так яблоко каждый раз падает из нового столбца.</p>"
        ),
        "code_content": None,
        "code_language": None,
        "video_url": None,
    ...
    # ------------------------------------------------------------------ 4
    {
        ...
        "text_content": (
            ...
            "<b>Boshqarish</b> (to'q sariq) bo'limidagi <code>doim takrorla</code> "
            "blokidan foydalanamiz — u ichidagi bloklarni cheksiz qayta-qayta "
            "bajaradi.</p>"
            "<pre><code>doim takrorla\n"
            "  y ni -5 ga o'zgartir</code></pre>"
            "<p><code>y ni -5 ga o'zgartir</code> — personajni biroz pastga "
            "suradi. <code>doim takrorla</code> ichida bo'lgani uchun olma "
        ...
        "text_content_ru": (
            ...
            "<code>doim takrorla</code> из раздела <b>Управление</b> "
            "(оранжевые) — он повторяет блоки внутри себя бесконечно.</p>"
            "<pre><code>doim takrorla\n"
            "  y ni -5 ga o'zgartir</code></pre>"
            "<p><code>y ni -5 ga o'zgartir</code> — сдвигает персонажа чуть "
            "вниз. Так как это внутри <code>doim takrorla</code>, яблоко "
    ...
    # ------------------------------------------------------------------ 5
    {
        ...
        "text_content": (
            ...
            "    ball ni 1 ga oshir\n"
            "    x: (-200 dan 200 gacha tasodifiy son) y: 150 ga o't</code></pre>"
        ),
        "text_content_ru": (
