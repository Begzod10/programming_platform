...
# ========== MONITORING, PROGRESS, STATISTICS & CRUD ==========
# Extracted to achievement_monitoring_service.py to keep this module under 800 lines.
# Re-exported here so all existing ``achievement_service.func_name`` call sites
# continue to work without any changes.
from app.services.achievement_monitoring_service import (
    get_achievement_progress,
    get_students_with_achievement,
    get_students_without_achievement,
